...
from .services import get_all_clients_db, get_client_by_id_db, get_parking_by_id_db, get_client_parking_by_ids_db
...
def create_app():
    ...
    def add_new_client_parking():
        ...
        try:
            ...
            parking = get_parking_by_id_db(parking_id=new_client_parking_dict['parking_id'])
    ...
    def delete_client_parking():
        ...
        try:
            ...
            if new_client_parking.time_out:
                return jsonify(error='There is no longer this car in the parking lot'), 400
